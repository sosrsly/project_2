...
<head>
    ...
    <link rel="shortcut icon" href="icons/uber1.png" type="image/png">
...
<body>
        ...
        <div class="subheader">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 offset-md-1 col-xl-2 offset-xl-2 hidden_block">
                        <div class="subheader_calling">Звоните нам ежедневно</div>
                        <a href="tel:84957970988" class="subheader_number">8 495 797 09 88</a>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 subheader_small_block">
                        <a href="tel:84957970988" class="subheader_small_screen">8 495 797 09 88</a>
    ...
    <section class="work">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 offset-0 col-sm-10 offset-sm-2 col-md-6 offset-md-0">
                    <div class="work_contant_block">
                        <div class="work_img"><img src="/icons/icon_1.png" alt=""></div>
                        <div class="work_text">
                    ...
                    <div class="work_contant_block">
                            <div class="work_img"><img src="/icons/icon_2.png" alt=""></div>
                            <div class="work_text">
                    ...
                    <div class="work_contant_block">
                            <div class="work_img"><img src="/icons/icon_3.png" alt=""></div>
                            <div class="work_text">
                    ...
                    <div class="work_contant_block">
                            <div class="work_img"><img src="/icons/icon_4.png" alt=""></div>
                            <div class="work_text">
                ...
                <div class="col-12 offset-0 col-sm-10 offset-sm-2 col-md-6 offset-md-0">
                        <div class="work_contant_block">
                                <div class="work_img"><img src="/icons/icon_5.png" alt=""></div>
                                <div class="work_text">
                        ...
                        <div class="work_contant_block">
                                <div class="work_img"><img src="/icons/icon_6.png" alt=""></div>
                                <div class="work_text">
                        ...
                        <div class="work_contant_block">
                                <div class="work_img"><img src="/icons/icon_7.png" alt=""></div>
                                <div class="work_text">
                        ...
                        <div class="work_contant_block">
                                <div class="work_img"><img src="/icons/icon_8.png" alt=""></div>
                                <div class="work_text work_text_6">
    ...
    <section class="mobile">
        <div class="container">
            ...
            <h3 class="mobile_subheader">Сделайте заказ, совершите поездку и оплатите ее стоимость, используя свой мобильный телефон</h3>

            <div class="row">
                <div class="col-12 offset-0 col-sm-10 offset-sm-2 col-md-6 offset-md-0 col-lg-4 offset-lg-0">
                    <div class="mobile_item mobile_1">
                ...
                <div class="col-12 offset-0 col-sm-10 offset-sm-2 col-md-6 offset-md-0 col-lg-4 offset-lg-0">
                    <div class="mobile_item mobile_2">
                        <div class="mobile_item_subtitle">
                            надежная подача
                        </div>
                        <div class="mobile_item_plus"></div>
                ...
                <div class="col-12 offset-0 col-sm-10 offset-sm-2 col-md-6 offset-md-0 col-lg-4 offset-lg-0">
                    <div class="mobile_item mobile_3">
                        <div class="mobile_item_subtitle">
                            прозрачные цены
                        </div>
                        <div class="mobile_item_plus"></div>
                ...
                <div class="col-12 offset-0 col-sm-10 offset-sm-2 col-md-6 offset-md-0 col-lg-4 offset-lg-0">
                    <div class="mobile_item mobile_4">
                        <div class="mobile_item_subtitle">
                            безналичная оплата
                        </div>
                        <div class="mobile_item_plus"></div>
                ...
                <div class="col-12 offset-0 col-sm-10 offset-sm-2 col-md-6 offset-md-0 col-lg-4 offset-lg-0">
                    <div class="mobile_item mobile_5">
                        <div class="mobile_item_subtitle">
                            обратная связь
                        </div>
                        <div class="mobile_item_plus"></div>
                ...
                <div class="col-12 offset-0 col-sm-10 offset-sm-2 col-md-6 offset-md-0 col-lg-4 offset-lg-0">
                    <div class="mobile_item mobile_6">
                        <div class="mobile_item_subtitle">
    ...
    <section class="car">
        <div class="container">
            <div class="label_new">возможности</div>
            <div class="title_new">Выбор - отличная штука!</div>
            <h3 class="car_subtitle">Закажите автомобиль, который подходит вам по стилю и бюджету</h3>

            <div class="car_image">
                <img src="/icons/logo_uber.png" alt="" class="car_image_logo">
                <img src="/img/car+circle.png" alt="" class="car_image_carandcircle">
            </div>
            <div class="car_text">
    ...
    <section class="require" id="require">
        <div class="container">
            ...
            <div class="row require_wrapper">
                <div class="col-md-10 offset-md-2 col-lg-6 offset-lg-0">
                    ...
                    <div class="require_list_subheader">В день заработок составляет 7000-12000р + бонус 3000т рублей</div>
                </div>
                <div class="col-md-10 offset-md-2 col-lg-6 offset-lg-0">
                ...
                <div class="col-md-10 offset-md-2 col-lg-6 offset-lg-0 warning">
                    <div class="require_title require_margin-top require_title_2">ТРЕБОВАНИЕ: </div>
                    <ul class="require_list require_list_2"> 
                ...
                <div class="col-md-10 offset-md-2 col-lg-6 offset-lg-0 warning">
                    <div class="require_title require_margin-top require_title_2">ДОКУМЕНТЫ: </div>
                    <ul class="require_list require_list_2"> 
    ...
    <section class="world">
        <div class="container">
            <div class="label_new">города</div>
            <div class="title_new">По всему миру</div>
            <h3 class="world_subtitle">Мы в вашем городе и по всему миру</h3>
            <div class="world_cities"><a href="">посмотреть все города</a></div>
    ...
    <footer class="footer">
        <div class="footer_social_icon">
            <div class="footer_social_icon_piece">
        ...
        <div class="footer_manager_icon">
             <img src="/icons/manager_icon.png" alt="">
        </div>
        <div class="container">
